package jupiterpi.banking.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "jupiterpi.banking") // includes sub packages
public class WebAppContextConfig extends WebMvcAutoConfiguration {
